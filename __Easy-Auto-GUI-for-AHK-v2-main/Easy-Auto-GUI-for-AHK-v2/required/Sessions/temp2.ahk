...
FileMenu.Add()
FileMenu.Add("&1: D:\Games\Age of Empires IV\Age of Empire 4.ahk", MenuHandler)
FileMenu.Add("&2: C:\Users\dower\AppData\Local\Programs\MatDeck\Files\Default\@STARTMENU@\SteamVR\Onward.xml", MenuHandler)
FileMenu.Add("&3: C:\Windows.old\Users\dower\AppData\Local\Vivox\Onward.xml", MenuHandler)
FileMenu.Add("&4: C:\Users\dower\OneDrive\__DISCORD_APP\_____GPT2_____\__chatGPT__reduex\.env", MenuHandler)
FileMenu.Add("&5: F:\IDA PRO 7\IDA Pro\python\3\gepetto\config.ini", MenuHandler)
FileMenu.Add("&6: C:\Users\dower\AppData\Local\Vivox\Breachers.xml", MenuHandler)
FileMenu.Add("&7: F:\SteamLibrary\steamapps\common\Breachers\Breachers_Data\StreamingAssets\SteamVR\OpenVRSettings.asset", MenuHandler)
FileMenu.Add("&8: C:\Users\dower\AppData\Roaming\Microsoft\Windows\Start Menu\SteamVR\HereSphere VR Video Player.xml", MenuHandler)
FileMenu.Add("&9: C:\Users\dower\OneDrive\Geo3D_Manager\TEST LIBRARIES FOR AHK\Adventure\Tools\GUI Designer\ControlColor.ahk", MenuHandler)
FileMenu.Add("1&0: C:\Users\dower\AppData\Local\Programs\MatDeck\Files\Default\@STARTMENU@\SteamVR\new 1.txt", MenuHandler)
...
SB := myGui.Add("StatusBar", , "Normal text file")
ogcButton := myGui.Add("Button", "x3 y679 w24 h23", "✕")
myGui.Add("Text", "x27 y684 w69 h20 +Right", "Find:")
Edit1 := myGui.Add("Edit", "x98 y681 w263 h20")
ogcButton := myGui.Add("Button", "x365 y679 w24 h23", "<")
ogcButton := myGui.Add("Button", "x395 y679 w24 h23", ">")
CheckBox1 := myGui.Add("CheckBox", "x435 y682 w150 h20", "Match &case")
CheckBox2 := myGui.Add("CheckBox", "x600 y682 w150 h20", "&Highlight all")
myGui.Add("Text", "x780 y684 w270 h20")
Tab := myGui.Add("Tab3", "x0 y25 w1080 h649", ["Tabnew 1"])
Tab.UseTab()
...
myGui.Title := "*new 1 - Notepad++ (Clone)"
myGui.Show("w1080 h697")
...
OnEventHandler(*)
{
	...
	. "ogcButton => " ogcButton.Value "`n" 
	. "Edit1 => " Edit1.Value "`n" 
	. "ogcButton => " ogcButton.Value "`n" 
	. "ogcButton => " ogcButton.Value "`n" 
	. "CheckBox1 => " CheckBox1.Value "`n" 
	. "CheckBox2 => " CheckBox2.Value "`n", 77, 277)
	SetTimer () => ToolTip(), -3000 ; tooltip timer
}
